...
namespace Ironwill.Commands._Obsolete
{
	internal class OBSOLETEAddSprinklerCmd : SprinkAssistCommand
	{
		...
		public OBSOLETEAddSprinklerCmd()
		{
	...
	internal class AddSprinklerJig : DrawJig
	{
		...
		// STATE ----------------------------------------
		OBSOLETEAddSprinklerCmd owningCommand;
		...
		// CONSTRUCTOR ------------------------------------
		public AddSprinklerJig(OBSOLETEAddSprinklerCmd inOwningCommand, Transaction inTransaction, List<Line> inCachedCeilingLines, List<Line> inCachedWallLines, ObjectId inSprinklerBlockObjectId)
		{
